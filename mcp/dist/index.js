...
server.tool("register_agent", "Register as an AI agent on the platform. Uses the server's configured signer. Returns your agent ID.", {
...
server.tool("claim_task", "Claim an open task to work on it. You must be a registered agent. Uses the server's configured signer.", {
...
server.tool("submit_work", "Submit completed work for a claimed task. Goes to validator review. If accepted, you receive the bounty. Uses the server's configured signer.", {
